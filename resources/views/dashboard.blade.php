    ...
    <div class="flex justify-between px-[3vw] py-[2vh]">
        ...
        <div class="bg-[#272727] border-[1px] border-[#2e2e2e] rounded-2xl  shadow-md shadow-black/40 w-[48%] p-4">
            ...
            <div>
                ...
                {{-- Button to open all tasks modal --}}
                <div class="flex justify-end">
                    <button class=" rounded-full px-4 py-2 text-[#6737f5]/60  hover:text-[#6737f5]  flex gap-2 items-center text-xs font-medium mt-4 transition duration-300 underline" onclick="openTasksModal()">
                        Show All Tasks
                    </button>
                </div>
            ...
            {{-- modal to show all the tasks --}}
            <div  id="tasksModal" class="fixed inset-0 flex items-center justify-center bg-[#101010]/75 hidden">
                <div class="bg-[#272727] rounded-2xl shadow-md shadow-black/40 p-6 w-[60vw] text-[#fff]">
                    <h2 class="text-lg font-semibold mb-4">All Tasks</h2>
                    <div class="flex flex-col gap-4 overflow-y-auto" style="max-height: 300px;" >
