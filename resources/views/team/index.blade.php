            ...
            <div
                ...
                <div class="flex justify-between items-center  pb-4">
                    ...
                    <button
                        ...
                        onclick="document.getElementById('createTeamModal').classList.add('hidden');">
                        &times;
                    </button>
                </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" onclick="document.getElementById('image').click()"
                                class="px-4 py-2 bg-[#2e2e2e] text-white rounded-full flex items-center space-x-2">
    ...
    <div class="px-[3vw] pb-[5vh]">
        <div class="flex flex-wrap gap-5">
            @foreach ($teams as $team)
                <div
                    class="relative w-[22.5vw] h-[40vh] shadow-md shadow-black/40 bg-[#1C1C1C] border-[#2e2e2e] border-[1px] py-2 px-3 rounded-lg group">
                    {{-- Delete button (only visible for team owner) --}}
                    @if(Auth::id() === $team->owner_id)
                    <div class="absolute bottom-20 right-5 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <a href="/team/show/{{ $team->id }}" class="block h-full">
                        <div class="w-[100%] h-[70%] relative">
                            <img class="w-[100%] h-[100%] rounded-lg object-cover "
                                src="{{ asset('storage/images/' . $team->image) }}" alt="{{ $team->name }}">
                            <div class="absolute top-2 right-1">
                                <span class="text-[#fff]/50 text-[12px] bg-[#1C1C1C] px-3 py-2 rounded-lg">Owner:
                                ...
                                <div class="flex items-center">
                                    ...
                                    @if ($team->users->count() > 2)
                                        <div class="relative group">
                                            <div
                                                class="ml-1 text-xs font-semibold text-[#6dc489] rounded-full cursor-pointer">
                                                +{{ $team->users->count() - 2 }}
                                            </div>
                                            <!-- Tooltip -->
                                            <div
                                                class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 hidden group-hover:block w-max">
                                                <div
                                                    class="bg-[#2e2e2e] text-white text-xs rounded-lg py-2 px-3 shadow-lg">
                                                    ...
                                                    <!-- Arrow -->
                                                    <div
                                                        class="absolute bottom-[-4px] left-1/2 transform -translate-x-1/2 w-2 h-2 bg-[#2e2e2e] rotate-45">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
